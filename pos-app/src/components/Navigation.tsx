...
const getNavigationItems = (permissions: ReturnType<typeof usePermissions>) => [
  ...
  },
  {
    ...
    show: permissions.isSeller() && !permissions.isAdmin(), // Solo vendedores, no administradores
  },
  {
    name: 'Borradores',
    href: '/sales/drafts',
...
export default function Navigation() {
  ...
  return (
    <>
      ...
      {/* Mobile Menu Overlay - Solo visible en móviles */}
      {isMobileMenuOpen && (
